...
{
  public:
    BuilderDesignPattern(char *type)
    {
        sprintf(_desc, " Type: %s", type);
    }
...
class Builder
{
  public:
    ...
    BuilderDesignPattern *getResult()
    {
        return _result;
    }
  protected:
    BuilderDesignPattern *_result;
};
...
class UnixBuilder: public Builder
{
  public:
    UnixBuilder()
    {
        _result = new BuilderDesignPattern("Unix");
    }
...
class VmsBuilder: public Builder
{
  public:
    VmsBuilder()
    {
        _result = new BuilderDesignPattern("Vms");
    }
    void configureFile(char *name)
    {
